# 🌍 Ethical Travel Platform

## Description

This is an **individual project** built in **48 hours**, designed to provide users with a sustainable travel platform. It helps travelers discover **eco-friendly destinations, responsible accommodations, and ethical experiences** that respect the environment and local cultures.

The project is developed using **React** for the frontend and **Node.js with Express** for the backend, with **MySQL** as the database.

## 🚀 Technologies Used

### Frontend:
- ⚪ **React** (Vite)
- 🎨 **CSS** (TailwindCSS or custom styling)

### Backend:
- 🟢 **Node.js**  
- ✨ **Express.js**  
- 🟣 **MySQL** (using Sequelize or raw queries)  

## 📌 Features

✔️ Browse sustainable travel destinations  
✔️ Find eco-friendly accommodations and ethical activities  
✔️ Save favorites for later  
✔️ Filter and sort recommendations  
...
Create a **MySQL database** and configure the `.env` file in the `server` directory:
```
...
The project should now be running on `http://localhost:3000` for the frontend and `http://localhost:5000` for the backend.

## 🏆 Challenge

This project was built **in just 48 hours**, making it a fast-paced challenge that required rapid development, decision-making, and optimization.

---

🎒 *Built with passion for ethical and sustainable travel.* 🌱 ✈️
